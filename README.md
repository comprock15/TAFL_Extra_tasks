...
В каждой последующей строке содержится информация о состоянии и переходах из него. Поле *является_ли_состояние_финальным* должно принимать одно из двух значений: + или -
